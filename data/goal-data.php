...
$goalData = [
	[
		"personal" => ["Move out of cold and overcast NYC to someplace sunny. Preferably California", "rescue a dog and cat"],
	], 
	[
		"professional" => ["opportunity for remote work", "be a good culture fit <br>the opportunity to mentor"],
		"company" => "I want to work for a company in the medical or education field. I feel like these two fields have the most impact on humanity",
		"expectations" => ["clear instructions <br>", "one-on-one support <br>", "respectuful communication <br>", "clear deliverables and timeline <br>"], 
	],
